...
// tracePattern matches // @ds-task T1.1: Description (AC-001)
// or // @ds-test T1.1: TestName (AC-001)
var tracePattern = regexp.MustCompile(`@ds-(task|test)\s+([A-Z0-9.]+)(?::\s*([^(]*))?(?:\s*\((AC-[0-9]+)\))?`)
...
func shouldSkip(path string) bool {
	...
	skipDirs := []string{"node_modules", "vendor", "dist", "bin", "obj", ".git", ".draftspec"}
