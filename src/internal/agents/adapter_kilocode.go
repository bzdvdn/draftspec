...
%s
`, spec.Name, spec.PromptPath, "/draftspec-"+spec.Name+".md", workflowChainHint(lang), spec.Name, scriptExecutionHint(lang), helpDiscoveryHint(lang), scriptListBlock(spec.Extras, lang), antiPatternHint(lang))
	}
