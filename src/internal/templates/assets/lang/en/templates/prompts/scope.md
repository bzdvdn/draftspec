...
- `.draftspec/plans/<slug>/tasks.md` — when `--tasks` or default mode applies
- `.draftspec/plans/<slug>/plan.md` — when `--plan` or default mode applies and tasks do not exist
...
- `.draftspec/plans/<slug>/challenge.md`
