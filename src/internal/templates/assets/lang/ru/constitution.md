...
- Именование веток SHOULD следовать принятому в проекте соглашению для spec-веток.
...
- Агенты и люди ДОЛЖНЫ обновлять `.draftspec/memory.md` после существенных изменений конституции.
