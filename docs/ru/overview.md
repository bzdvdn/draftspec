...
`draftspec` хранит намерение проекта, спецификации, плановые артефакты, задачи и рабочую память в обычных файлах. Цель инструмента — дать людям и агентам один и тот же проектный контекст без жесткого процессного движка.
